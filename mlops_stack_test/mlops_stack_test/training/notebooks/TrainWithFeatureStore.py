...
# ``mlops_stack_test/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_stack_test-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_stack_test.mlops_stack_test-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_stack_test.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_stack_test.trip_dropoff_features",
